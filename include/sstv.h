...
#define SSTV_PWM_CLKDIV 2 // PWM clock divider value f_pwm = f_clock/(CLKDIV*(WRAP+1)) // 2? / Maybe 4?
...
#define SSTV_SAMPLE_RATE ((1200 * 16) * 0.93)
...
#define SSTV_BUFF_LEN (SSTV_WIDTH * SSTV_HEIGHT * 2)
